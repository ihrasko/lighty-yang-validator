...
The distribution will be stored in the **"target"** directory, as a file called *lighty-yang-validator-25.0.0-SNAPSHOT-bin.zip*
...
```
unzip lighty-yang-validator-25.0.0-SNAPSHOT-bin.zip
```
